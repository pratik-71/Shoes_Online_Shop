...
const Order_placed = () => {
   ...
   const get_success = async () => {
    try {
        const response = await axios.post(
            "http://localhost:3001/products/add_order",
            {
                product: product._id,
                address: address._id,
        ...
        if (error.response && error.response.status === 404) {
            ...
            setwrong("Error occurred while placing order");
        }
    }
};
    ...
    <div>
      ...
      <div className='text-center'> 
           ...
           <>
            <Row >
            <div className="text-center my-4">
            <h4 className='text-danger'>Sorry ! Could Not place Order</h4>
            </div>
      </Row>
      <Row>
          <div className="text-center">
              <img style={{height:"50vh",maxHeight:"55vh"}} src='https://www.recordacard.com.au/cdn/shop/products/SorryEmoji_1438x.png?v=1587104881'
              ></img>
          </div>
      </Row>
      <Row>
      <div className='text-center'> 
         ...
         <Row><h4 className='text-center text-danger'>{wrong}</h4></Row>
